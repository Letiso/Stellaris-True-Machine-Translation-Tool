...
"color: #ffffff;")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.StringsList.setText(_translate("Dialog", "Файлы мода добавлены в коллекцию.Файл сохранен.Версия файлов локализации была обновлена.Успешное совмещение со внешним файлом.Моды успешно отсортированы.Язык интерфейса был изменен\\nПерезапустите утилиту, чтобы увидеть изменения.Неверный ключ [Для разработчиков]"))
