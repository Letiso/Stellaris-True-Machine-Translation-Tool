...
"    }")
        ...
        self.InfoLabel_1.setGeometry(QtCore.QRect(60, 40, 521, 41))
        font = QtGui.QFont()
        font.setFamily("laCartoonerie(RUS BY LYAJKA)")
...
"}")
        ...
        self.InfoLabel_4.setGeometry(QtCore.QRect(30, 140, 591, 31))
        font = QtGui.QFont()
        font.setFamily("laCartoonerie(RUS BY LYAJKA)")
        font.setPointSize(11)
        font.setBold(False)
...
"color: #ffffff;")
        ...
        self.InfoLabel_3.setGeometry(QtCore.QRect(150, 90, 361, 41))
        font = QtGui.QFont()
        font.setFamily("laCartoonerie(RUS BY LYAJKA)")
        font.setPointSize(11)
        font.setBold(False)
