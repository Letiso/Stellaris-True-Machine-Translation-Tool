...
"    }")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.StringsList.setText(_translate("Dialog", "Уверенны, что хотите перевести этот мод?.Желаете начать перевод файла.Вы уверены что хотите сохранить перевод?.Желаете проверить обновления в огригинальных файлах?\n"
"Этот процесс автоматический.Желаете выбрать внешний файл с переводом, чтобы совместить его с текущим?.Неверный ключ [Для разработчиков]"))
